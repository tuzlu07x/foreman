...
// USD per million tokens. Refresh quarterly — these are placeholder figures
// from late 2025 / early 2026 pricing pages; production deployments should
// re-pull from anthropic.com/pricing.
...
export function calculateCostUsd(
  ...
  if (!pricing) {
    // Unknown model: use Haiku pricing as a conservative floor so we never
    // silently under-bill a future model release. Logged via the audit row.
